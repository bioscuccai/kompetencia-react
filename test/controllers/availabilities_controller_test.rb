...
class AvailabilitiesControllerTest < ActionController::TestCase
  ...
  test "should create availability" do
    assert_difference('Availability.count') do
      post :create, availability: { comment: @availability.comment, end: @availability.end, start: @availability.start, user_id: @availability.user_id }
    end
  ...
  test "should update availability" do
    patch :update, id: @availability, availability: { comment: @availability.comment, end: @availability.end, start: @availability.start, user_id: @availability.user_id }
    assert_redirected_to availability_path(assigns(:availability))
  end
